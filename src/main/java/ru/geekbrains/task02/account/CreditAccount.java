...
public class CreditAccount extends AccountBase{
    ...
    private CreditAccount(String accountNumber, BigDecimal balance) {
        super(balance);
        this.accountNumber = accountNumber;
    }

    public static CreditAccount CreateAccount(BigDecimal initialAmountOfMoney) throws IllegalMoneyAmountException {
        ...
        return new CreditAccount(generateAccountNumber(), initialAmountOfMoney);
    }
    @Override
